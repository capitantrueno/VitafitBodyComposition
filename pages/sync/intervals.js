...
export default function Intervals() {
    ...
    const submitIntervalsForm = async (event) => {
        event.preventDefault();
        ...
        <>
            <div className='flex flex-wrap'>
                <div className='w-full max-w-sm ml-auto mr-auto'>
                    <h1 className='text-2xl font-bold text-center mb-5'>Intervals Body Composition Form</h1>
                    <form onSubmit={submitIntervalsForm}
                        className=''>
